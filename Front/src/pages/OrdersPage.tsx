    ...
    <>
      <header className="orders-header">
        <nav>
          ...
          <Link className="nav-button light" to="/">
            Volver a productos
          </Link>
        </nav>
        ...
        <div>
          ...
          <h1>Mis pedidos</h1>
          <p>Consulta las compras creadas y su estado actual.</p>
        </div>
      </header>
      ...
      <main className="orders-main">
        ...
        {!loading && !error && orders.length === 0 && (
          <div className="empty-orders">
            ...
            <p>Crea tu primera compra desde el catálogo.</p>
          ...
          {orders.map((order) => (
            <article className="order-card" key={order.id}>
              ...
              <div className="order-total">
                <span>Total</span>
                <strong>{formatCop(order.totalInCents)}</strong>
              </div>
            </article>
          ))}
        </section>
